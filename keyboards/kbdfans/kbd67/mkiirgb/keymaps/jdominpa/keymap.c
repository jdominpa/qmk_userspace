...
/* Layers */
#define LA_NAV LT(_NAVIGATION, KC_SPC)
#define LA_LOW LT(_LOWER, KC_A)
#define LA_RAI LT(_RAISE, KC_SCLN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_ALPHA] = LAYOUT_65_ansi_blocker( /* Alphas layer */
		...
		KC_ESC,   LA_LOW,    LGUI_T(KC_S),  LALT_T(KC_D),  LCTL_T(KC_F),  KC_G,    KC_H,   RCTL_T(KC_J),  RALT_T(KC_K),  RGUI_T(KC_L),   LA_RAI,    KC_QUOT,           KC_ENT,    TG_GAME,
	...
	[_LOWER] = LAYOUT_65_ansi_blocker( /* Lower layer */
		...
		OS_SHFT,  KC_AT,    KC_LBRC,  KC_RBRC,  KC_QUES,  KC_GRV,   XXXXXXX,  KC_1,     KC_2,     KC_3,     XXXXXXX,  OS_SHFT,            XXXXXXX,  XXXXXXX,
		XXXXXXX,  XXXXXXX,  XXXXXXX,                      XXXXXXX,                      XXXXXXX,            XXXXXXX,  XXXXXXX,            XXXXXXX,  XXXXXXX),
	...
	[_RAISE] = LAYOUT_65_ansi_blocker( /* Raise layer */
		...
		XXXXXXX,  XXXXXXX,  KC_F6,    KC_F5,    KC_F4,    XXXXXXX,  KC_HASH,  KC_PLUS,  KC_MINS,  KC_ASTR,  XXXXXXX,  XXXXXXX,            XXXXXXX,  XXXXXXX,
