...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_GAMING] = LAYOUT_65_ansi_blocker( /* Gaming layer */
		...
		KC_TAB,   KC_Q,          KC_W,       KC_E,    KC_R,  KC_T,    KC_Y,   KC_U,   KC_I,      KC_O,     KC_P,     KC_LBRC,  KC_RBRC, KC_BSLS,   MO(_MEDIA),
	...
	[_NAVIGATION] = LAYOUT_65_ansi_blocker( /* Navigation and editing layer */
		...
		KC_CAPS,  XXXXXXX,  KC_LGUI,  KC_LALT,  KC_LCTL,  XXXXXXX,  XXXXXXX,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  XXXXXXX,            XXXXXXX,  XXXXXXX,
